...
async function renderAdminPanel() {
  ...
  try {
    ...
    content.querySelector('.admin-users')?.insertAdjacentHTML('afterend', `<header class="admin-page-header"><div><h1 class="admin-section-title">GAME CONTROL</h1><p>Manage questions and set results.</p></div><div class="admin-header-actions"><button class="admin-cancel-button" id="admin-logout" type="button">Sign out</button><button class="admin-add-button" id="show-question-form" type="button"><span aria-hidden="true">+</span> Add Question</button></div></header>`)
